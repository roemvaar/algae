...
RUN_TEST(test_linked_list_prepend_cleanup);

void test_linked_list_prepend_cleanup(void)
{
    struct list_node* list = NULL;
    ...
    // Clean up
    list_free(list);  // Assuming you have a function to free the entire list
}